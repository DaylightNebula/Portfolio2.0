...
## Packet Bundle
`PacketBundle` is the name used for packet listeners and they opperate in a similar fasion to `EventListener`s.  However, bundles are also in charge of registering java packets by doing the following.
