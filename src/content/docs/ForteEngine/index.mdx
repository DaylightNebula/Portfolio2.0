...
The second allows you to use the Egui immeidiate mode UI library to make quick debugging UI.  The third allows you to easily add 2D UI to your app.
    ...
    PASSES {
        ...
        0: {
            ...
            PARTS: [
                ...
                {
                    // Egui doesnt need a pipeline, but one must be set anyway
                    PIPELINE: "forte.ui",
