...
{
    "type": "stay",
    "world": 0,                     // The dimension in which the entity should stay.  By default this is 0 or the overworld.
...
{
    "type": "wander",
    "world": 0,                     // The dimension in which the entity is present.  By default this is 0 or the overworld.
